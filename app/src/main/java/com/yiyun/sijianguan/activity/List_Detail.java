 ...
 * 
 */
public class List_Detail extends BaseActivity implements OnClickListener {
	...
	TextView apply_num_detail, work_area_detail, village_detail,
			...
			contractNUM, apply_update_detail;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		init();
		pic_sq.setOnClickListener(List_Detail.this);
		sp_save.setOnClickListener(List_Detail.this);
		sp_cancel.setOnClickListener(List_Detail.this);
		process_btn.setOnClickListener(List_Detail.this);
		sp_digital_sign.setOnClickListener(List_Detail.this);
		sqresult_radiogroup.setOnCheckedChangeListener(radio_listener);
	}

	public void init() {
		cd = new ConnectionDetector(List_Detail.this);
		...
		sign_pic = (ImageView) findViewById(R.id.sign_pic);
		sp_digital_sign = (Button) findViewById(R.id.sp_digital_sign);
		sp_content = (EditText) findViewById(R.id.sp_ds);
		radioButton1 = (RadioButton) findViewById(R.id.radioButton1);
		radioButton2 = (RadioButton) findViewById(R.id.radioButton2);
		radioButton3 = (RadioButton) findViewById(R.id.radioButton3);
		sqresult_radiogroup = (RadioGroup) findViewById(R.id.sqresult_radiogroup);
		sp_save = (Button) findViewById(R.id.sp_save);
		sp_cancel = (Button) findViewById(R.id.sp_cancel);
		process_btn = (Button) findViewById(R.id.process_btn);
		pic_sq = (Button) findViewById(R.id.pic_sq);
		apply_num_detail = (TextView) findViewById(R.id.apply_num_detail);
		work_area_detail = (TextView) findViewById(R.id.work_area_detail);
		village_detail = (TextView) findViewById(R.id.village_detail);
		process_name_detail = (TextView) findViewById(R.id.process_name_detail);
		apply_type_detail = (TextView) findViewById(R.id.apply_type_detail);
		apply_content_detail = (TextView) findViewById(R.id.apply_content_detail);
		apply_money_detail = (TextView) findViewById(R.id.apply_money_detail);
		apply_man_detail = (TextView) findViewById(R.id.apply_man_detail);
		apply_date_detail = (TextView) findViewById(R.id.apply_date_detail);
		contractNUM = (TextView) findViewById(R.id.contractNUM);
	...
	public void onClick(View v) {
		...
		case R.id.process_btn:
			Intent intent0 = new Intent(List_Detail.this, Process_Detail.class);
		...
		case R.id.pic_sq:
			if (sq_pic_status == 1) {
				Intent intent3 = new Intent(List_Detail.this, Pic_res.class);
				intent3.putStringArrayListExtra("url", pic_url);
				intent3.putExtra("activity_type", "list_datail_sq");
				startActivity(intent3);
			}
			break;
		case R.id.sp_digital_sign:
			Intent intent1 = new Intent(List_Detail.this, Digital_sign.class);
		...
		case R.id.sp_save:
			...
			if (cd.isConn()) {
				...
				cd.setNetworkMethod(List_Detail.this);
			}

			break;
		case R.id.sp_cancel:
			Intent intent = new Intent(List_Detail.this, MainActivity.class);
	...
	private class download_image_url_task extends AsyncTask<Void, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			progress = new ProgressDialog(List_Detail.this);
	...
	private class argiculturl_upload_data_task extends
		...
		protected String doInBackground(Void... arg0) {
			...
			// 调用的方法名称
			String methodName = "Agricultural_upload_data";
			// 命名空间
			String nameSpace = Common_data.nameSpace;
			// EndPoint
			String endPoint = Common_data.endPoint;
		...
		protected void onPostExecute(String result) {
			...
			if (("success").equals(result)) {
				Toast.makeText(List_Detail.this, "保存成功！", Toast.LENGTH_LONG)
						.show();
				Intent intent = new Intent(List_Detail.this, MainActivity.class);
				startActivity(intent);

			} else if (("failed").equals(result)) {
				Toast.makeText(List_Detail.this, "保存失败！", Toast.LENGTH_LONG)
						.show();
			} else if (result == null) {
				Toast.makeText(List_Detail.this, "网络异常！", Toast.LENGTH_LONG)
						.show();
			}
	...
	private class Imag_upload_task extends AsyncTask<Void, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			progress_url = new ProgressDialog(List_Detail.this);
			...
			progress_url.setOnCancelListener(new OnCancelListener() {
				...
				public void onCancel(DialogInterface arg0) {
					// TODO Auto-generated method stub
					cancel(true);
					Toast.makeText(List_Detail.this, "您已取消上传！",
							Toast.LENGTH_LONG).show();
				}
			});
		}
		...
		protected void onPostExecute(String result) {
			...
			if (("设备未就绪。").equals(result)) {
				Toast.makeText(List_Detail.this, "服务器图片路径异常！",
						Toast.LENGTH_LONG).show();
				...
				Toast.makeText(List_Detail.this, "图片上传失败！", Toast.LENGTH_LONG)
						.show();
			}
